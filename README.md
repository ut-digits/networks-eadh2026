...
Teaching materials for the workshop _Network Analysis in Ditital Humanities_ taught at the EADH 2026 conference on Sept. 15, 2026, and organized by the project DigiTS (Center for Digital Text Scholarship) at the University of Tartu (see: https://digits.ut.ee/). 
...
- **Teachers:** Botond Szemes, Maciej Eder
...
See the workshop reading list in [`readings.md`](readings.md).
